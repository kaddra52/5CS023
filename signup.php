    ...
    {    
        ...
        {  
            ...
            $confirm_password = $_POST["confirm_password"];
                ...
                {
                    $error_message_style = "display:block;";
                }
                else
                {
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">                  
                  <span class="d-none d-lg-block">Elite Properties</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">                 
                  <div class="pt-4 pb-2">
                    ...
                    <h5 class="card-title text-center pb-0 fs-4">Sign Up for New Account</h5>
                    <p class="text-center small"></p>
                  </div>
                  <div class="alert alert-primary" role="alert" style="<?=$acknowledgment_message_style?>">
                    Signup successfull. You can login now. <a href="login.php">Login</a>
                  </div>
                  <div class="alert alert-danger" role="alert" style="<?=$error_message_style?>">
                  ...
                  <div class="col-12">
                    ...
                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Select User Type</label>
                    ...
                    <div class="col-12">
                    <font style="font-size:13px;">Login to your account<a href="login.php"> Login</a></font>
                    </div>
                  </form>
